...
if (isset($_SESSION['ultima_actividad']) && (time() - $_SESSION['ultima_actividad']) > $inactividad_limite) {
    ...
    session_unset();
    session_destroy();
    header("Location: Prog_Web_II_Tarea8_productos.php"); // Redirigir al inicio de sesión
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="Prog_Web_II_Tarea8_estilos.css"> <!-- Enlace al archivo CSS -->
</head>
<body>
    ...
    <?php foreach ($productos as $producto): ?>
        <div class="producto">
            ...
            <div class="detalle-producto">
                ...
                <a href="Prog_Web_II_Tarea5_agregar.php?id=<?= $producto['id'] ?>" class="btn-agregar">Agregar al carrito</a>
            </div>
        </div>
    <?php endforeach; ?>
